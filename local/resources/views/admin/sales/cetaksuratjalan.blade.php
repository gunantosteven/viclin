...
<div class="row-fluid">
    ...
    <div class="span12">
        <div class="head clearfix">
            ...
            {!! Form::open(['method' => 'POST', 'route'=>['admin.sales.cetaksuratjalan.showfaktur']]) !!}
        ...
        @if($juals != null)
            @foreach ($juals as $key => $jual)
                <tr>
                     ...
                     <td><a href="{{url('admin/sales/cetaksuratjalan',$jual->nojual)}}" class="btn" target="_blank">Print</a></td>
                </tr>
            @endforeach
        @endif
        </td>
