...
<div class="row-fluid">
    ...
    <div class="span12">
        <div class="head clearfix">
            ...
            {!! Form::open(['method' => 'POST', 'route'=>['owner.purchase.inputpenyusutan.showfaktur']]) !!}
...
<div class="row-fluid">
    ...
    <div class="span12">
        ...
        {!! Form::open(['method' => 'PATCH', 'route'=>['owner.purchase.inputpenyusutan.update']]) !!}
        <div class="block-fluid"> 
            <div class="row-form clearfix">
