...
@section('content')
<h1>Revision Purchase Invoice</h1>
<hr>
<div class="row-fluid">
    ...
    <div class="span12">
        <div class="head clearfix">
            ...
            {!! Form::open(['method' => 'POST', 'route'=>['owner.purchase.revisifaktur.showfaktur']]) !!}
        ...
        @if($belis != null)
            @foreach ($belis as $key => $beli)
                <tr>
                     ...
                     <td><a href="{{url('owner/purchase/revisifaktur',$beli->nobeli)}}" class="btn">Revisi</a></td>
                </tr>
            @endforeach
        @endif
        </td>
