...
@section('content')
<h1>History Revision Purchase Invoice</h1>
<hr>
<div class="row-fluid">
    ...
    <div class="span12">
        <div class="head clearfix">
            ...
            {!! Form::open(['method' => 'POST', 'route'=>['owner.history.revisipurchase.showfaktur']]) !!}
        ...
        @if($revisis != null)
            @foreach ($revisis as $key => $revisi)
                <tr>
                     ...
                     <td><a href="{{route('owner.history.revisipurchase.read',$revisi['id'])}}" class="btn btn-warning">OK</a></td>
                </tr>
            @endforeach
        @endif
        </td>
